import {
  WalletUtil
} from "./chunk-YARLWCGU.js";
import {
  W3mFrameHelpers,
  W3mFrameProvider
} from "./chunk-C6X7UTBU.js";
import {
  CaipNetworksUtil,
...
var AppKitBaseClient = class {
  constructor(options) {
    ...
    this.getCaipNetwork = (chainNamespace) => {
      var _a2, _b;
      if (chainNamespace) {
        const namespaceCaipNetwork = (_a2 = ChainController.getNetworkData(chainNamespace)) == null ? void 0 : _a2.caipNetwork;
        if (namespaceCaipNetwork) {
          return namespaceCaipNetwork;
        }
        return (_b = ChainController.getRequestedCaipNetworks(chainNamespace).filter((c) => c.chainNamespace === chainNamespace)) == null ? void 0 : _b[0];
      }
    ...
    this.connectionControllerClient = {
      ...
      connectExternal: async ({ id, info, type, provider, chain, caipNetwork }) => {
        ...
        const res = await adapter.connect({
          ...
          rpcUrl: ((_d = (_c = (_b = caipNetwork == null ? void 0 : caipNetwork.rpcUrls) == null ? void 0 : _b.default) == null ? void 0 : _c.http) == null ? void 0 : _d[0]) || ((_g = (_f = (_e = fallbackCaipNetwork == null ? void 0 : fallbackCaipNetwork.rpcUrls) == null ? void 0 : _e.default) == null ? void 0 : _f.http) == null ? void 0 : _g[0])
        });
        if (!res) {
          return;
        }
  ...
  listenAdapter(chainNamespace) {
    ...
    adapter.on("switchNetwork", ({ address, chainId }) => {
      var _a;
      const caipNetwork = (_a = this.caipNetworks) == null ? void 0 : _a.find((n) => n.id === chainId || n.caipNetworkId === chainId);
...
var AppKit = class extends AppKitBaseClient {
  ...
  createAuthProvider(chainNamespace) {
    ...
    const isSocialsEnabled = ((_f = (_e = this.options) == null ? void 0 : _e.features) == null ? void 0 : _f.socials) ? ((_i = (_h = (_g = this.options) == null ? void 0 : _g.features) == null ? void 0 : _h.socials) == null ? void 0 : _i.length) > 0 : ConstantsUtil2.DEFAULT_FEATURES.socials;
    ...
    if (!this.authProvider && ((_j = this.options) == null ? void 0 : _j.projectId) && isAuthEnabled) {
      this.authProvider = W3mFrameProviderSingleton.getInstance({
        ...
        chainId: (_k = this.getCaipNetwork(chainNamespace)) == null ? void 0 : _k.caipNetworkId,
        onTimeout: () => {
    ...
    if (!isInitialized && CoreHelperUtil.isClient()) {
      ...
      if (features) {
        ...
        if (usingEmbeddedWallet) {
          featureImportPromises.push(import("./embedded-wallet-TW73HQZ6.js"));
        }
        if (features.email) {
          featureImportPromises.push(import("./email-ERPLMBL2.js"));
        }
        if (features.socials) {
          featureImportPromises.push(import("./socials-ZMICFW25.js"));
        }
        if (features.swaps) {
          featureImportPromises.push(import("./swaps-OSOZALZU.js"));
        }
        if (features.send) {
          featureImportPromises.push(import("./send-IATY4QWP.js"));
        }
        if (features.receive) {
          featureImportPromises.push(import("./receive-LFRRHB73.js"));
        }
        if (features.onramp) {
          featureImportPromises.push(import("./onramp-R4PTLKEN.js"));
        }
        if (features.history) {
          featureImportPromises.push(import("./transactions-QXZ6HNDI.js"));
        }
      }
      await Promise.all([
        ...featureImportPromises,
        import("./exports-PJGZHJTI.js"),
        import("./w3m-modal-PLKZJECP.js")
      ]);
...
//# sourceMappingURL=chunk-JQJORWEF.js.map

import{i as E,r as P,C as S,O as b,R as g,e as A,x as l,A as u,q as W,n as R,k as d,t as O,o as L,S as C,M as I,T as y,j as _}from"./index-c304ef2d.js";import{n as D,r as c,c as T,o as f}from"./if-defined-09170453.js";import"./index-91579d44.js";import{e as j}from"./index-0ab06c43.js";import"./index-2aad5d0a.js";import"./index-53ffb43c.js";import"./index-4869f36f.js";import"./index-c4fde5ff.js";import"./index-77dc3379.js";import"./index-0beaf934.js";import"./index-6f011271.js";const q=E`
  :host {
...
`;var x=globalThis&&globalThis.__decorate||function(s,e,i,o){var n=arguments.length,t=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(s,e,i,o);else for(var a=s.length-1;a>=0;a--)(r=s[a])&&(t=(n<3?r(t):n>3?r(e,i,t):r(e,i))||t);return n>3&&t&&Object.defineProperty(e,i,t),t};let p=class extends P{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=S.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.features=b.state.features,this.unsubscribe.push(S.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(i=>i.type==="AUTH")}),b.subscribeKey("features",e=>this.features=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var t;let e=((t=this.features)==null?void 0:t.socials)||[];const i=!!this.authConnector,o=e==null?void 0:e.length,n=g.state.view==="ConnectSocials";return(!i||!o)&&!n?null:(n&&!o&&(e=A.DEFAULT_FEATURES.socials),l` <wui-flex flexDirection="column" gap="xs">
      ${e.map(r=>l`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){e&&await j(e)}};p.styles=q;x([D()],p.prototype,"tabIdx",void 0);x([c()],p.prototype,"connectors",void 0);x([c()],p.prototype,"authConnector",void 0);x([c()],p.prototype,"features",void 0);p=x([T("w3m-social-login-list")],p);const z=E`
  wui-flex {
...
`;var U=globalThis&&globalThis.__decorate||function(s,e,i,o){var n=arguments.length,t=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(s,e,i,o);else for(var a=s.length-1;a>=0;a--)(r=s[a])&&(t=(n<3?r(t):n>3?r(e,i,t):r(e,i))||t);return n>3&&t&&Object.defineProperty(e,i,t),t};let $=class extends P{constructor(){super(...arguments),this.checked=!1}render(){var k;const{termsConditionsUrl:e,privacyPolicyUrl:i}=b.state,o=(k=b.state.features)==null?void 0:k.legalCheckbox,t=!!(e||i)&&!!o,r=t&&!this.checked,a=r?-1:void 0;return l`
      ...
      >
        <w3m-social-login-list tabIdx=${f(a)}></w3m-social-login-list>
      </wui-flex>
      <w3m-legal-footer></w3m-legal-footer>
    `}onCheckboxChange(e){this.checked=!!e.detail}};$.styles=z;U([c()],$.prototype,"checked",void 0);$=U([T("w3m-connect-socials-view")],$);const N=E`
  wui-logo {
    width: 80px;
    height: 80px;
...
`;var m=globalThis&&globalThis.__decorate||function(s,e,i,o){var n=arguments.length,t=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(s,e,i,o);else for(var a=s.length-1;a>=0;a--)(r=s[a])&&(t=(n<3?r(t):n>3?r(e,i,t):r(e,i))||t);return n>3&&t&&Object.defineProperty(e,i,t),t};let h=class extends P{constructor(){super(),this.unsubscribe=[],this.socialProvider=u.state.socialProvider,this.socialWindow=u.state.socialWindow,this.error=!1,this.connecting=!1,this.message="Connect in the provider window",this.authConnector=S.getAuthConnector(),this.handleSocialConnection=async e=>{var i;if((i=e.data)!=null&&i.resultUri)if(e.origin===W.SECURE_SITE_ORIGIN){window.removeEventListener("message",this.handleSocialConnection,!1);try{if(this.authConnector&&!this.connecting){this.socialWindow&&(this.socialWindow.close(),u.setSocialWindow(void 0,R.state.activeChain)),this.connecting=!0,this.updateMessage();const o=e.data.resultUri;this.socialProvider&&d.sendEvent({type:"track",event:"SOCIAL_LOGIN_REQUEST_USER_DATA",properties:{provider:this.socialProvider}}),await this.authConnector.provider.connectSocial(o),this.socialProvider&&(O.setConnectedSocialProvider(this.socialProvider),await L.connectExternal(this.authConnector,this.authConnector.chain),d.sendEvent({type:"track",event:"SOCIAL_LOGIN_SUCCESS",properties:{provider:this.socialProvider}}))}}catch{this.error=!0,this.updateMessage(),this.socialProvider&&d.sendEvent({type:"track",event:"SOCIAL_LOGIN_ERROR",properties:{provider:this.socialProvider}})}}else g.goBack(),C.showError("Untrusted Origin"),this.socialProvider&&d.sendEvent({type:"track",event:"SOCIAL_LOGIN_ERROR",properties:{provider:this.socialProvider}})},this.unsubscribe.push(u.subscribe(e=>{e.socialProvider&&(this.socialProvider=e.socialProvider),e.socialWindow&&(this.socialWindow=e.socialWindow),e.address&&(I.state.open||b.state.enableEmbedded)&&I.close()})),this.authConnector&&this.connectSocial()}disconnectedCallback(){var e;this.unsubscribe.forEach(i=>i()),window.removeEventListener("message",this.handleSocialConnection,!1),(e=this.socialWindow)==null||e.close(),u.setSocialWindow(void 0,R.state.activeChain)}render(){return l`
      ...
      >
        <wui-flex justifyContent="center" alignItems="center">
          <wui-logo logo=${f(this.socialProvider)}></wui-logo>
...
`;var v=globalThis&&globalThis.__decorate||function(s,e,i,o){var n=arguments.length,t=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(s,e,i,o);else for(var a=s.length-1;a>=0;a--)(r=s[a])&&(t=(n<3?r(t):n>3?r(e,i,t):r(e,i))||t);return n>3&&t&&Object.defineProperty(e,i,t),t};let w=class extends P{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.socialProvider=u.state.socialProvider,this.uri=u.state.farcasterUrl,this.ready=!1,this.loading=!1,this.authConnector=S.getAuthConnector(),this.forceUpdate=()=>{this.requestUpdate()},this.unsubscribe.push(u.subscribeKey("farcasterUrl",e=>{e&&(this.uri=e,this.connectFarcaster())}),u.subscribeKey("socialProvider",e=>{e&&(this.socialProvider=e)})),window.addEventListener("resize",this.forceUpdate)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.timeout),window.removeEventListener("resize",this.forceUpdate)}render(){return this.onRenderProxy(),l`${this.platformTemplate()}`}platformTemplate(){return _.isMobile()?l`${this.mobileTemplate()}`:l`${this.desktopTemplate()}`}desktopTemplate(){return this.loading?l`${this.loadingTemplate()}`:l`${this.qrTemplate()}`}qrTemplate(){return l` <wui-flex
    ...
    </wui-flex>`}loaderTemplate(){const e=y.state.themeVariables["--w3m-border-radius-master"],i=e?parseInt(e.replace("px",""),10):4;return l`<wui-loading-thumbnail radius=${i*9}></wui-loading-thumbnail>`}async connectFarcaster(){var e;if(this.authConnector)try{await((e=this.authConnector)==null?void 0:e.provider.connectFarcaster()),this.socialProvider&&(O.setConnectedSocialProvider(this.socialProvider),d.sendEvent({type:"track",event:"SOCIAL_LOGIN_REQUEST_USER_DATA",properties:{provider:this.socialProvider}})),this.loading=!0,await L.connectExternal(this.authConnector,this.authConnector.chain),this.socialProvider&&d.sendEvent({type:"track",event:"SOCIAL_LOGIN_SUCCESS",properties:{provider:this.socialProvider}}),this.loading=!1,I.close()}catch(i){this.socialProvider&&d.sendEvent({type:"track",event:"SOCIAL_LOGIN_ERROR",properties:{provider:this.socialProvider}}),g.goBack(),C.showError(i)}}mobileLinkTemplate(){return l`<wui-button
      size="md"
    ...
    >`}onRenderProxy(){!this.ready&&this.uri&&(this.timeout=setTimeout(()=>{this.ready=!0},200))}qrCodeTemplate(){if(!this.uri||!this.ready)return null;const e=this.getBoundingClientRect().width-40;return l` <wui-qr-code
      ...
      color=${f(y.state.themeVariables["--w3m-qr-color"])}
    ...
    >
      ...
      Copy link
    </wui-link>`}onCopyUri(){try{this.uri&&(_.copyToClopboard(this.uri),C.showSuccess("Link copied"))}catch{C.showError("Failed to copy")}}};w.styles=V;v([c()],w.prototype,"socialProvider",void 0);v([c()],w.prototype,"uri",void 0);v([c()],w.prototype,"ready",void 0);v([c()],w.prototype,"loading",void 0);w=v([T("w3m-connecting-farcaster-view")],w);export{$ as W3mConnectSocialsView,w as W3mConnectingFarcasterView,h as W3mConnectingSocialView};

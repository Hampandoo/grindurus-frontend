import{y as re,z as ie,B as se,n as D,h as oe,A as _,D as ae,F as Y,G as V,H as J,i as R,r as g,x as c,I as B,J as C,O as U,M as P,w as ne,k as Z,W as ee,R as E,j as F,e as K,o as ce,S as M,T as le}from"./index-c304ef2d.js";import{n as d,c as y,o as m,r as p}from"./if-defined-09170453.js";import{D as ue,T as pe}from"./index-7a7da7c0.js";import"./index-2aad5d0a.js";import"./index-6f011271.js";import"./index-0beaf934.js";import"./index-53f06950.js";import"./index-91579d44.js";import"./index-4869f36f.js";import"./index-53ffb43c.js";import"./index-d367e553.js";import"./index-77dc3379.js";const N={id:"2b92315d-eab7-5bef-84fa-089a131333f5",name:"USD Coin",symbol:"USDC",networks:[{name:"ethereum-mainnet",display_name:"Ethereum",chain_id:"1",contract_address:"0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"},{name:"polygon-mainnet",display_name:"Polygon",chain_id:"137",contract_address:"0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174"}]},q={id:"USD",payment_method_limits:[{id:"card",min:"10.00",max:"7500.00"},{id:"ach_bank_account",min:"10.00",max:"25000.00"}]},de={providers:J,selectedProvider:null,error:null,purchaseCurrency:N,paymentCurrency:q,purchaseCurrencies:[N],paymentCurrencies:[],quotesLoading:!1},l=re(de),u={state:l,subscribe(s){return ie(l,()=>s(l))},subscribeKey(s,e){return se(l,s,e)},setSelectedProvider(s){if(s&&s.name==="meld"){const e=D.state.activeChain===oe.CHAIN.SOLANA?"SOL":"USDC",t=_.state.address??"",i=new URL(s.url);i.searchParams.append("publicKey",ae),i.searchParams.append("destinationCurrencyCode",e),i.searchParams.append("walletAddress",t),s.url=i.toString()}l.selectedProvider=s},setPurchaseCurrency(s){l.purchaseCurrency=s},setPaymentCurrency(s){l.paymentCurrency=s},setPurchaseAmount(s){this.state.purchaseAmount=s},setPaymentAmount(s){this.state.paymentAmount=s},async getAvailableCurrencies(){const s=await Y.getOnrampOptions();l.purchaseCurrencies=s.purchaseCurrencies,l.paymentCurrencies=s.paymentCurrencies,l.paymentCurrency=s.paymentCurrencies[0]||q,l.purchaseCurrency=s.purchaseCurrencies[0]||N,await V.fetchCurrencyImages(s.paymentCurrencies.map(e=>e.id)),await V.fetchTokenImages(s.purchaseCurrencies.map(e=>e.symbol))},async getQuote(){var s,e;l.quotesLoading=!0;try{const t=await Y.getOnrampQuote({purchaseCurrency:l.purchaseCurrency,paymentCurrency:l.paymentCurrency,amount:((s=l.paymentAmount)==null?void 0:s.toString())||"0",network:(e=l.purchaseCurrency)==null?void 0:e.symbol});return l.quotesLoading=!1,l.purchaseAmount=Number(t==null?void 0:t.purchaseAmount.amount),t}catch(t){return l.error=t.message,l.quotesLoading=!1,null}finally{l.quotesLoading=!1}},resetState(){l.providers=J,l.selectedProvider=null,l.error=null,l.purchaseCurrency=N,l.paymentCurrency=q,l.purchaseCurrencies=[N],l.paymentCurrencies=[],l.paymentAmount=void 0,l.purchaseAmount=void 0,l.quotesLoading=!1}},he=R`
  :host {
    width: 100%;
  }
...
`;var L=globalThis&&globalThis.__decorate||function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var n=s.length-1;n>=0;n--)(a=s[n])&&(r=(o<3?a(r):o>3?a(e,t,r):a(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};const we=7;let $=class extends g{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=u.state.selectedProvider,this.loading=!1,this.coinbaseTransactions=B.state.coinbaseTransactions,this.tokenImages=C.state.tokenImages,this.unsubscribe.push(u.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e}),C.subscribeKey("tokenImages",e=>this.tokenImages=e),()=>{clearTimeout(this.refetchTimeout)},B.subscribe(e=>{this.coinbaseTransactions={...e.coinbaseTransactions}})),B.clearCursor(),this.fetchTransactions()}render(){return c`
...
`;var W=globalThis&&globalThis.__decorate||function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var n=s.length-1;n>=0;n--)(a=s[n])&&(r=(o<3?a(r):o>3?a(e,t,r):a(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};let O=class extends g{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=u.state.paymentCurrency,this.currencies=u.state.paymentCurrencies,this.currencyImages=C.state.currencyImages,this.checked=!1,this.unsubscribe.push(u.subscribe(e=>{this.selectedCurrency=e.paymentCurrency,this.currencies=e.paymentCurrencies}),C.subscribeKey("currencyImages",e=>this.currencyImages=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var n;const{termsConditionsUrl:e,privacyPolicyUrl:t}=U.state,i=(n=U.state.features)==null?void 0:n.legalCheckbox,a=!!(e||t)&&!!i&&!this.checked;return c`
    ...
    `}currenciesTemplate(e=!1){return this.currencies.map(t=>{var i;return c`
      ...
      `})}selectCurrency(e){e&&(u.setPaymentCurrency(e),P.close())}onCheckboxChange(e){this.checked=!!e.detail}};O.styles=fe;W([p()],O.prototype,"selectedCurrency",void 0);W([p()],O.prototype,"currencies",void 0);W([p()],O.prototype,"currencyImages",void 0);W([p()],O.prototype,"checked",void 0);O=W([y("w3m-onramp-fiat-select-view")],O);const ge=R`
  button {
    padding: var(--wui-spacing-s);
    border-radius: var(--wui-border-radius-xs);
    border: none;
...
`;var z=globalThis&&globalThis.__decorate||function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var n=s.length-1;n>=0;n--)(a=s[n])&&(r=(o<3?a(r):o>3?a(e,t,r):a(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};let k=class extends g{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=u.state.purchaseCurrencies,this.tokens=u.state.purchaseCurrencies,this.tokenImages=C.state.tokenImages,this.checked=!1,this.unsubscribe.push(u.subscribe(e=>{this.selectedCurrency=e.purchaseCurrencies,this.tokens=e.purchaseCurrencies}),C.subscribeKey("tokenImages",e=>this.tokenImages=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var n;const{termsConditionsUrl:e,privacyPolicyUrl:t}=U.state,i=(n=U.state.features)==null?void 0:n.legalCheckbox,a=!!(e||t)&&!!i&&!this.checked;return c`
    ...
    `}currenciesTemplate(e=!1){return this.tokens.map(t=>{var i;return c`
      ...
      `})}selectToken(e){e&&(u.setPurchaseCurrency(e),P.close())}onCheckboxChange(e){this.checked=!!e.detail}};k.styles=ve;z([p()],k.prototype,"selectedCurrency",void 0);z([p()],k.prototype,"tokens",void 0);z([p()],k.prototype,"tokenImages",void 0);z([p()],k.prototype,"checked",void 0);k=z([y("w3m-onramp-token-select-view")],k);const xe=R`
  @keyframes shake {
    0% {
...
`;var I=globalThis&&globalThis.__decorate||function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var n=s.length-1;n>=0;n--)(a=s[n])&&(r=(o<3?a(r):o>3?a(e,t,r):a(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};const Ae={USD:"$",EUR:"€",GBP:"£"},Ie=[100,250,500,1e3];let x=class extends g{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.caipAddress=D.state.activeCaipAddress,this.loading=P.state.loading,this.paymentCurrency=u.state.paymentCurrency,this.paymentAmount=u.state.paymentAmount,this.purchaseAmount=u.state.purchaseAmount,this.quoteLoading=u.state.quotesLoading,this.unsubscribe.push(D.subscribeKey("activeCaipAddress",e=>this.caipAddress=e),P.subscribeKey("loading",e=>{this.loading=e}),u.subscribe(e=>{this.paymentCurrency=e.paymentCurrency,this.paymentAmount=e.paymentAmount,this.purchaseAmount=e.purchaseAmount,this.quoteLoading=e.quotesLoading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return c`
    ...
    `}templateButton(){return this.caipAddress?c`<wui-button
        ...
        >
          Connect wallet
        </wui-button>`}getQuotes(){this.loading||P.open({view:"OnRampProviders"})}openModal(){P.open({view:"Connect"})}async onPaymentAmountChange(e){u.setPaymentAmount(Number(e.detail)),await u.getQuote()}async selectPresetAmount(e){u.setPaymentAmount(e),await u.getQuote()}};x.styles=Re;I([d({type:Boolean})],x.prototype,"disabled",void 0);I([p()],x.prototype,"caipAddress",void 0);I([p()],x.prototype,"loading",void 0);I([p()],x.prototype,"paymentCurrency",void 0);I([p()],x.prototype,"paymentAmount",void 0);I([p()],x.prototype,"purchaseAmount",void 0);I([p()],x.prototype,"quoteLoading",void 0);x=I([y("w3m-onramp-widget")],x);export{w as W3mBuyInProgressView,$ as W3mOnRampActivityView,G as W3mOnRampProvidersView,O as W3mOnrampFiatSelectView,k as W3mOnrampTokensView,x as W3mOnrampWidget,X as W3mWhatIsABuyView};
